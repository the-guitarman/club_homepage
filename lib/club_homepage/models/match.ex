defmodule ClubHomepage.Match do
  ...
  schema "matches" do
    ...
    field :after_extra_time, :boolean, default: false
    field :after_penalty_shootout, :boolean, default: false
  ...
  @cast_fields ~w(parent_id competition_id season_id team_id opponent_team_id start_at home_match active meeting_point_id team_goals opponent_team_goals after_extra_time after_penalty_shootout failure_reason description match_events meeting_point_at json_creation fussball_de_match_id)a
