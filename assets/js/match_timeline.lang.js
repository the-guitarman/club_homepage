...
let matchTimelineTranslationProvider = {
  init: () => {
    let matchTimeline = $(MatchTimelineConstants.timelineEl);
    if (matchTimeline.length > 0) {
      let language = matchTimeline.data('language');
...
export default matchTimelineTranslationProvider;
